 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://placeservice/", wsdlLocation = "http://localhost:8080/mSoapServer/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://placeservice/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/mSoapServer/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://placeservice/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://placeservice/", "HelloWorldPort"), HelloWorld.class, features);
    }
